...
INSERT INTO administration.users (id, external_id, version, created_on, name, email, password, active, default_language)
VALUES (200, 'a75ed639-6935-4c6b-8037-95575ab0ba46', 0, current_timestamp, 'Other User', 'other-user@webbudget.com.br',
        '$2a$11$gofMXY5BBXVbwoPHbYiCd.6PJ.2pIZk01XRiI8gnVut8t6kFWoOle', true, 'EN_US');

INSERT INTO administration.roles(id, external_id, version, created_on, name)
...
INSERT INTO administration.grants (external_id, version, created_on, id_user, id_role)
VALUES ('05e9d984-8bff-4842-9feb-fd2c513a08e8', 0, current_timestamp, 100, 100);

INSERT INTO administration.grants (external_id, version, created_on, id_user, id_role)
VALUES ('e5f54104-28a0-4e2e-a2bc-ddc6a38ba05e', 0, current_timestamp, 200, 101);
