...
VALUES (998, '287e26fa-763b-4efb-908e-734e637bb6fd', 0, current_timestamp, current_timestamp,
        'Academia', '2024-12-30', 320.00, 'OPEN', NULL, 'Despesas com a nova academia', 997, NULL, NULL, NULL);
...
VALUES (997, '413b96ec-fed9-487f-b587-7bb9c4989020', 0, current_timestamp, current_timestamp,
        'Academia', '2024-08-30', 320.00, 'ACCOUNTED', NULL, 'Despesas com a nova academia', 998, NULL, NULL, NULL);

INSERT INTO financial.apportionments (external_id, "version", created_on, last_update, value, id_movement_class,
                                      id_period_movement, id_recurring_movement)
VALUES ('25d79017-eefd-4b66-949c-c32c03b177af', 0, current_timestamp, current_timestamp,
        320.00, 998, 998, NULL);